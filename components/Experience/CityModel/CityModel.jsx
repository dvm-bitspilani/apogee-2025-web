...
import { useGLTF, useAnimations, Billboard, Text3D } from "@react-three/drei";
  ...
  const handleClick = () => {
    ...
    gsap.to(startSpherical, {
      ...
      onUpdate: () => {
        ...
        camera.lookAt(0, 0, 0); // Adjust if needed
      },
      onComplete: () => {
        camera.updateProjectionMatrix(); // Ensure changes are applied
      },
    });
  };
